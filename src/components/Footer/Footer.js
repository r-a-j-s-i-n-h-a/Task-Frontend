...
import './Footer.css';
import zoro from './images/cbs0fdsh8464tdk12tts.webp'
        ...
        <div>
            <div className="beforef">
                <div className="contenter">
                    <h3 id="bf1">Deliver your best work <span id="bf2">with EsaLink.com</span></h3>
                    <h1 id="bf3">Customer satisfication? Our priority</h1>
                    <h6>Our various customers and partners allow us to bring you the best solutions.</h6>
                    <button className="bt1get">Contact Us
            ...
            <div className="footer">
                <div className="logosec">
                    <img id="mondayl" src={zoro} alt="Esalink.com Logo" />
                    <p>Pricing</p>
                    <p>Contact@esalink.com</p>
                    <h1>France</h1>
                    <p>2 rue Jules Meline ,51430</p>
                    <p>Uk</p>
                    <p>Nonprofits</p>
                    <p>App marketplace</p>
                    <p>24/7 support</p>
